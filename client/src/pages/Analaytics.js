...
//       console.log("inside userAnaytics", token);
//       try {
//         const response = await userAnalytic(token);
//         console.log("response in useranlaytics", response); // Assuming your API endpoint is "/api/getUserAnalytics"
...
//             <tr>
//               <td>Total Blogs</td>
//               <td>{userAnalytics[0].totalBlogs}</td>
//             </tr>
//             <tr>
//               <td>Total Views</td>
//               <td>{userAnalytics[0].totalViews}</td>
//             </tr>
//             <tr>
//               <td>Total Upvotes</td>
//               <td>{userAnalytics[0].totalUpvotes}</td>
//             </tr>
//             <tr>
//               <td>Total Downvotes</td>
//               <td>{userAnalytics[0].totalDownvotes}</td>
//             </tr>
//             <tr>
//               <td>Total Comments</td>
//               <td>{userAnalytics[0].totalComments}</td>
//             </tr>
//           </tbody>
//         </table>
//       )}
