...
<html>
  ...
  <body>
    <div class="container">
     ...
     <div class="lt">
            <a href="">
            <img class="logo" src="../../../client/src/assets/images/Removebg new.png" alt="logoOnly"></a>
        ...
        <div class="card">
          ...
          <div class="body">
                ...
                <p>Verify your email to finish signing up with CredLock. Use the </br>following verification code:</p>
        ...
        <div class="support">For any further queries or clarification, feel free to reach out to us by visiting <a
					href="mailto:sundram.smn@gmail.com">credlock@homes.com</a>. We are here to help!</div>
		</div> 
      </div>
      <!--4444  -->
      </div>
